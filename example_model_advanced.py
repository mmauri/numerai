...
if model_selection_loop:
    ...
    download_data(napi, 'numerai_training_data_int8.parquet', 'numerai_training_data_int8.parquet')
...
download_data(napi, 'numerai_tournament_data_int8.parquet', f'numerai_tournament_data_{current_round}_int8.parquet')
print("downloading validation_data")
download_data(napi, 'numerai_validation_data_int8.parquet', 'numerai_validation_data_int8.parquet')
print("downloading example_predictions")
download_data(napi, 'example_predictions_int8.parquet', f'example_predictions_{current_round}_int8.parquet')
print("downloading example_validation_predictions")
download_data(napi, 'example_validation_predictions_int8.parquet', f'example_validation_predictions_int8.parquet')
...
validation_example_preds = pd.read_parquet('example_validation_predictions_int8.parquet')
